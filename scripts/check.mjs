...
for(const needle of ['homeButton','homeButtonTop','autonomousToggle'])if(!fs.readFileSync(path.join(root,'public/index.html'),'utf8').includes(needle))failures.push(`navigation/autonomy UI missing: ${needle}`);
