...
for(const needle of ['SERVICE_DIR="$HOME/.config/systemd/user"','CWEB_STATE_DIR=','CWEB_CONFIG_DIR=','systemctl --user is-active'])if(!installer.includes(needle))failures.push(`installer hardening missing: ${needle}`);
